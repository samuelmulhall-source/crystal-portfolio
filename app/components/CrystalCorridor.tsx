 ...
 *   1. Back smoke (50 frames sampled every 4th from 200-frame sequence, depth atmosphere, subtle parallax)
 *   2. Front smoke (50 frames sampled every 4th from 200-frame sequence, foreground atmosphere, stronger parallax)
 *
...
export default function CrystalCorridor() {
  ...
  const loadFrame = useCallback((
    ...
    return new Promise((resolve, reject) => {
      ...
      const img = new Image();
      img.decoding = "async";
      const sourceIndex = (index * 4) + 1; // maps 0→1, 1→5, 2→9, ..., 49→197
      const padded = String(Math.min(sourceIndex, 200)).padStart(2, "0");
